 ...
 * 
 * */
public class AndroidCommitmentFull extends Activity implements Runnable{
	...
	private void setupTop() {
		...
		titleDate.setText("All Commitments");
		...
		refresh.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
		        pd = ProgressDialog.show(AndroidCommitmentFull.this, "Loading..", "Getting Calendar Data", true,
		                false);
		        Thread thread = new Thread(AndroidCommitmentFull.this);
		        thread.start();
			}
